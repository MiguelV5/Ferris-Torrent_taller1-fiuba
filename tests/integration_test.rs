...
//         handler::{handle_general_interaction_with_peers, BLOCK_BYTES},
...
//         torrent_status::{self, StateOfDownload, TorrentStatus},
...
// fn server_peer_interaction_mock_for_continue_receiving_an_entire_piece_without_shutdown(
//     listener: TcpListener,
// ) -> Result<(), Box<dyn Error>> {
//     let (mut server_stream, _addr) = listener.accept()?;
...
// fn server_peer_interaction_mock_for_receiving_an_entire_file_without_shutdown(
//     listener: TcpListener,
// ) -> Result<(), Box<dyn Error>> {
//     let (mut server_stream, _addr) = listener.accept()?;
...
// fn server_peer_interaction_mock_for_receiving_and_shareing_pieces_without_shutdown(
//     listener: TcpListener,
// ) -> Result<(), Box<dyn Error>> {
//     let (mut server_stream, _addr) = listener.accept()?;
...
//     let torrent_status_for_check = torrent_status.clone();
...
//     let interaction_result = client_peer.interact_with_peer(&torrent_file_data, torrent_status);
...
// #[test]
// fn client_peer_interact_with_a_peer_and_completes_the_hole_file_ok() -> Result<(), Box<dyn Error>> {
//     //ABRO LA CONEXION
//     let (listener, address) = try_bind_listener(STARTING_PORT)?;
...
//     let handle = thread::spawn(move || {
//         let _result =
//             server_peer_interaction_mock_for_receiving_an_entire_file_without_shutdown(listener);
//     });
...
//     // );
//     // assert_eq!(0, torrent_status.left);
//     // assert_eq!(
//     //     vec![
//     //         PieceStatus::ValidAndAvailablePiece,
//     //         PieceStatus::ValidAndAvailablePiece
...
// // ) -> Result<(), Box<dyn Error>> {
// //     //ABRO LA CONEXION
// //     let (listener1, address1) = try_bind_listener(STARTING_PORT)?;
...
// //     let handle = thread::spawn(move || {
// //         let _result =
// //             server_peer_interaction_mock_for_receiving_an_entire_piece_with_shutdown(listener1);
// //     });
// //     let handle2 = thread::spawn(move || {
// //         let _result =
// //             server_peer_interaction_mock_for_continue_receiving_an_entire_piece_without_shutdown(
// //                 listener2,
// //             );
// //     });
// //     let peer_id = generate_peer_id();

// //     handle_general_interaction_with_peers(
// //         &torrent_file_data,
// //         &tracker_response_data,
// //         &mut torrent_status,
// //         &config_data,
...
// //     let (tracker_response_data, mut torrent_status, torrent_file_data) =
// //         create_default_client_peer_with_a_server_peer_that_has_the_whole_file(
// //             "test_complete_and_share_ok.txt",
// //             SocketAddr::from_str(&address)?,
// //         )?;
// //     let path = torrent_file_data.get_torrent_representative_name();
// //     let _dir_creation = fs::create_dir(format!("temp/{}", path));
