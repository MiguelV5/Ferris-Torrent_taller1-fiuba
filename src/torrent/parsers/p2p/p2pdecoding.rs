use super::p2p_constants::*;
use super::p2p_message::*;
...
///
/// ```
/// # use fa_torrent::torrent::parsers::p2p::p2pdecoding::decode_p2p_message;
...
///         amount_of_bytes: 3
///     }),
///     decode_p2p_message(&p2p_msg_bytes)
/// );
/// ```
///
pub fn decode_p2p_message(bytes: &[u8]) -> Result<P2PMessage, P2PMessageError> {
...
mod tests_p2p_decoder {
    ...
    mod tests_decode_p2p_message {
        ...
        fn decode_choke_ok() {
            ...
            assert_eq!(Ok(P2PMessage::Choke), decode_p2p_message(&p2p_msg_bytes));
        }

        #[test]
        fn decode_unchoke_ok() {
            let p2p_msg_bytes = [0, 0, 0, 1, ID_UNCHOKE];
            assert_eq!(Ok(P2PMessage::Unchoke), decode_p2p_message(&p2p_msg_bytes));
        }
